...
namespace RobotCleaner.Tests
{
    ...
    public class RobotTests
    {
        ...
        [TestMethod]
        public void RunRobot_NotAllowedOutOfBoundsCommandSet_RobotPositionShouldRemainWithinBounds()
        {
            //arrange
            CommandFactory commandFactory = new CommandFactory();
            commandFactory.AddInput("1");
        ...
        [TestMethod]
        public void RunRobot_EasiestCommandSetOneMove_RobotReports1LocationCleaned()
        {
            //arrange
            CommandFactory commandFactory = new CommandFactory();
            commandFactory.AddInput("1");
        ...
        [TestMethod]
        public void RunRobot_GridMoveCommandSet_NumberOfLocationsIsCorrect()
        {
            //arrange
            CommandFactory commandFactory = new CommandFactory();
